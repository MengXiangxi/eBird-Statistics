...
远东山雀的分类学困难，看似是形态学上的混乱，但其本源实际上就是这种基因多样性谜题。在我根据eBird数据库中记录所绘制的山雀属部分种的分布图上看，P. major、P. minor加上P. cinereus这几种鸟，围绕着青藏高原构成了一个环。注意这张图上一些种间分界线受到记录整理方面的人为因素影响，同时由于eBird是一个在我国不甚流行的观鸟记录数据库，在没有人提交观鸟记录的地点是没有信息的。


图3. eBird数据库中Parus属三种鸟的记录分布

环形种的概念是否适用，几代专家提出了很多针锋相对的意见。早在1928年，即有人在阿穆尔河下游的major/minor接触区同时观察到现在称大山雀和远东山雀的两种鸟。但关于这两种鸟是否能“通婚”，不同人有不同的看法。如果能够“通婚”，那就说明存在基因交流，环形种不成立，这两类鸟属于同种不同亚种。如果不能“通婚”，说明这两种生殖隔离的鸟已经可以算是分属不同的种了[15]。2004年，德国美因茨大学一位博士在其学位论文课题中对这个问题进行深入的考察，结合了蛋白序列比较、形态学研究和声音分析，最终确认了环形种的成立——尽管存在着小范围、不常见的“通婚”情形，总的来说P. major和P. minor两类鸟并不能发生有效的基因传递。[16,17]本文被分类学家广泛接受，也成了确立P. minor独立种地位的主要依据。不过后来仍有人通过mtDNA测序的有力证据对这一结论提出质疑。
